...
export default class extends Component {
  render() {
    return <footer id="footer" className="footer-1">
    <div className="main-footer widgets-dark typo-light">
    <div className="container">
    <div className="row">    
    <div className="col-xs-12 col-sm-6 col-md-3">
    <div className="widget subscribe no-box">
    <h5 className="widget-title">ZCAR MEDIA<span></span></h5>
    <p>Chuyên USB nhạc chất lượng 
cao cho ô tô. Cam kết hoàn tiền 
100% nếu sản phẩm có lỗi. Bảo 
hành 5 năm.
    </p>
    </div>
    </div>
    ...
    <div className="thumb-content"><Link
          ...
          offset={-70}
          duration= {500}
          ><a href="#">Tư Vấn Mua Hàng</a></Link></div>	
    </li>
    <li>
    <div className="thumb-content"><Link
          activeClass="active"
          ...
          offset={-70}
          duration= {500}
          ><a href="#">Thông Tin Sản Phẩm</a></Link></div>	
    </li>
    <li>
    <div className="thumb-content"><Link
          activeClass="active"
          ...
          offset={-70}
          duration= {500}
          ><a href="#">Các Gói Usb Nhạc</a></Link></div>	
    </li>
    <li>
    <div className="thumb-content"><Link
          activeClass="active"
          ...
          offset={-70}
          duration= {500}
          ><a href="#">Phản Hồi Khách Hàng</a></Link></div>	
    </li>
    </ul>
    </div>
    </div>
    ...
    <div className="col-xs-12 col-sm-6 col-md-3">
    <div className="widget no-box">
    <h5 className="widget-title">LIÊN HỆ<span></span></h5>
      Hotline: 0866.121.839<br />
      Địa chỉ: Sảnh B, Tòa nhà TeccoSky<br /> 
      Ville, Ngũ Hiệp, Thanh Trì, <br />
      Hà Nội.<br />
      <a href="https://www.messenger.com/t/usb.zcarmedia" target = '_blank' title="Facebook">Facebook</a>
    </div>
    </div>
    ...
    <div className="widget no-box">
    <h5 className="widget-title">THANH TOÁN<span></span></h5>
      Tiền mặt<br />
      Internet banking<br />
