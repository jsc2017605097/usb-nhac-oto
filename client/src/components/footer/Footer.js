...
export default class extends Component {
  render() {
    ...
    <p>Hotline: 0866.121.839<br />
      Địa chỉ: Sảnh B, Tòa nhà TeccoSky 
      Ville, Ngũ Hiệp, Thanh Trì, 
      Hà Nội.<br />
      <a href="https://www.messenger.com/t/usb.zcarmedia" target ='_blank' title="glorythemes">Facebook</a>
      </p>
